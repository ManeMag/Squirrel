...
class TransactionSpendings:Fragment(R.layout.fragment_transaction_spendings), DatePickerDialog.OnDateSetListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch{
            val response: HttpResponse = Program.client.get("${Program.protocol}://${Program.domain}:${Program.port}/api/category/2")
            ...
            {
                var drawable = ContextCompat.getDrawable(requireContext(), R.drawable.oval)
